...
Esse projeto tem como objetivo criar um site para a ACB (Associação de Conselheiros do Brasil)
...
- [BRAINSTORM](./docs/melhorias/brainstorm.md)
- [MAPA MENTAL](./docs/mindmap/MindMap.png)
- [ROADMAP](https://miro.com/app/board/uXjVGkRRFX4=/)
...
- [ANÁLISE HIERÁRQUICA DE TAREFAS](./docs/AHT/AHT-ACB.png)
